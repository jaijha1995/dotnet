                ...
                <div class="block-flat">
                    ...
                    <div>
                        ...
                        <div class="content">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <asp:TextBox ID="txtconfirm" runat="server" class="form-control" placeholder="Confirm Password"
                        ...
                        <div class="foot">
                              ...
                              <asp:Button ID="btnResetPassword" runat="server" Text="Save Password" CssClass="btn btn-default"  OnClick="btnResetPassword_Click" />
                        </div>
                    </div>
                </div>
            </div>
