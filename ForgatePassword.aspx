                ...
                <div class="block-flat">
                    ...
                    <div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox ID="txtforgotpassword" runat="server" class="form-control" placeholder="Email"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="foot">
                              ...
                              <asp:Button ID="btnResetPassword" runat="server" Text="Reset Password" CssClass="btn btn-default" OnClick="btnResetPassword_Click" />
                        </div>
                    </div>
                </div>
            </div>
